...
class APIManager: ObservableObject{
    ...
    func fetchPlaces(query:String,completion: @escaping (Result<Initial,Error>) -> Void)
    {
        let headers = [
          ...
          let request = NSMutableURLRequest(url: NSURL(string: "https://api.foursquare.com/v3/places/search?query=\(query)&ll=41.8781%2C-87.6298&limit=30") as! URL,
